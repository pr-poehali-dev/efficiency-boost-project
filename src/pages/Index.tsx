...
const budget = [
  { item: "Лицензии ERP (100 рабочих мест 1С)", cost: "3 000 000 – 5 000 000 ₽" },
  ...
  { item: "Обучение персонала (100 операторов 1С)", cost: "1 000 000 – 2 000 000 ₽" },
  { item: "Непредвиденные расходы (10%)", cost: "3 700 000 – 5 400 000 ₽" },
  { item: "ИТОГО (год 1)", cost: "40 700 000 – 59 400 000 ₽", total: true },
];
            ...
            <div style={{ animation: "fadeIn 0.3s ease" }}>
              ...
              <div style={{ background: "linear-gradient(135deg, #1a1a2e, #16213e)", borderRadius: 16, padding: 32, marginBottom: 20, color: "#fff" }}>
                ...
                <div style={{ fontSize: 22, fontWeight: 700, lineHeight: 1.4, marginBottom: 16 }}>
                  При выручке 19 245 млн ₽, 1 100 чел. и <span style={{ color: "#8bc34a" }}>100 рабочих мест 1С</span> предприятие теряет<br />
                  до <span style={{ color: "#8bc34a" }}>75–120 млн ₽/год</span> только на ручном учёте и ошибках операторов
                </div>
              ...
              <div style={{ background: "#fff", borderRadius: 16, padding: 28, boxShadow: "0 1px 4px rgba(0,0,0,0.06)", borderTop: "4px solid #8bc34a" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
                  {[
                    ...
                    { label: "Потенциал экономии (ФОТ + ошибки)", value: "75–120 млн ₽", icon: "Banknote" },
                  ].map((kpi) => (
            ...
            <div style={{ animation: "fadeIn 0.3s ease" }}>
              ...
              <div style={{ background: "#fff", borderRadius: 16, padding: 28, marginBottom: 20, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
                ...
                <div style={{ background: "#fff8e1", border: "1px solid #ffe082", borderRadius: 10, padding: "12px 18px", marginBottom: 4, fontSize: 13, color: "#7a5c00", lineHeight: 1.7 }}>
                  <strong>Исходные условия:</strong> предприятие работает на «1С:Предприятие» без внедрённой ERP-системы. Численность — 1 100 чел., годовой ФОТ — 1 700 млн ₽ (средняя ставка 765 ₽/ч). Учёт — преимущественно ручной: Excel, журналы, неструктурированные базы 1С. Основные потери — дублирование ввода данных, отсутствие сквозной аналитики, ручная сверка и согласование документов.
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  <FormulaBlock
                    ...
                    formula="Э_фот = (Т_дубл × Ч_опер × С_час) × 12"
                    desc="Т_дубл — время на ручной перенос, сверку и согласование документов в 1С в месяц (ч)  ·  Ч_опер — число операторов 1С (рабочих мест)  ·  С_час — стоимость часа (₽)"
                    example="Расчёт: 30 ч × 100 рабочих мест × 765 ₽ × 12 мес. ≈ 27 540 000 ₽/год"
                  />
                  <FormulaBlock
                    step="02"
                    title="Снижение потерь от ошибок ручного учёта и пересортицы"
                    formula="Э_ош = (N_ош × С_ош) × К_снижения"
                    desc="N_ош — ошибки в месяц из-за ручного ввода в 1С (пересортица, недостачи, ошибки в документах) — пропорционально 100 рабочим местам  ·  С_ош — стоимость устранения  ·  К_снижения = 0.7 (–70%)"
                    example="Расчёт: 14 ош. × 40 000 ₽ × 0.7 × 12 = 47 040 000 ₽/год"
                  />
                  <FormulaBlock
                    step="03"
              ...
              <div style={{ background: "#fff", borderRadius: 16, padding: 28, marginBottom: 20, boxShadow: "0 1px 4px rgba(0,0,0,0.06)", borderTop: "4px solid #8bc34a" }}>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  ...
                  <tbody>
                    {[
                      { name: "Экономия ФОТ (30 ч × 100 рабочих мест × 765 ₽)", y1: "13 770 000", y2: "27 540 000", y3: "27 540 000" },
                      { name: "Снижение потерь от ошибок ручного учёта", y1: "23 520 000", y2: "47 040 000", y3: "47 040 000" },
                      { name: "Рост выручки (+15% произв-ти всей компании)", y1: "1 443 375 000", y2: "2 886 750 000", y3: "2 886 750 000" },
                      { name: "Суммарный эффект", y1: "1 480 665 000", y2: "2 961 330 000", y3: "2 961 330 000", bold: true },
                      { name: "Затраты (ERP + интеграция 1С + обучение)", y1: "50 000 000", y2: "10 000 000", y3: "10 000 000" },
                      { name: "Чистый эффект", y1: "1 430 665 000", y2: "2 951 330 000", y3: "2 951 330 000", green: true },
                    ].map((row, i) => (
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
                {[
                  { label: "ROI (1-й год)", value: "2 861%", sub: "без ERP → с ERP, 100 рабочих мест 1С", icon: "Percent" },
                  { label: "Срок окупаемости", value: "~2–3 нед.", sub: "после завершения внедрения ERP", icon: "Clock" },
                  { label: "Чистый эффект (3 года)", value: "7,3 млрд ₽", sub: "при выручке 19 245 млн ₽/год (1 100 чел.)", icon: "Banknote" },
                ].map((kpi) => (
